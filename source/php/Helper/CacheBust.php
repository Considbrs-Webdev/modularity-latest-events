...
namespace ModularityLatestEvents\Helper;
 ...
 * 
 * @package ModularityLatestEvents\Helper
 */
class CacheBust
{
     ...
     *
     * @param string $name The original filename (e.g., 'css/modularity-latest-events.css')
    ...
    private static function getManifest(): ?array
    {
        ...
        $manifestPath = MODULARITYLATESTEVENTS_PATH . 'assets/dist/manifest.json';
